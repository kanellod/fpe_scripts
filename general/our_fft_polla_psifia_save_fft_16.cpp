...
{	
	...
	/* !!! Attention we must subtract 1 each time we use the matrix F
   	...
   	long int p,kk,n,jj,i,ii,ll, arxh_song;
...
//////////////////////////////////////////////////////////////////////
   ...
   //Anoigma arxeiou gia diavasma
	...
	//myfile.open ("Marianne_Beate_Kielland_Sergej_Osadchuk_Come_Away_Death.txt");
