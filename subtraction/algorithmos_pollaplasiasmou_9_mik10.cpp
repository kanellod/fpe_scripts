...
//		{
	...
	//		mpfr_set_str(fs,"1.11888",10,MPFR_RNDN);
	//		mpfr_set_str(ds,"1.11888",10,MPFR_RNDN);
	//	}
...
*/
		...
		else
		{
			...
			mpfr_sub_si(fx,fz,3,MPFR_RNDN);
			mpfr_sub_si(dx,dz,3,MPFR_RNDN);
